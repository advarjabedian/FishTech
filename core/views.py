    ...
    try:
        ...
        if existing:
            if existing.is_active:
                ...
                CompanyProductType.objects.update_or_create(
                    company_id=0,
                    product_type=slug,
        ...
        # Note: company_id=0 represents master set - we'll handle this differently in multi-tenant
        # For now, skip this auto-activation
...
def restore_product_type(request):
    ...
    try:
        ...
        # Note: Skip master set auto-activation for multi-tenant
