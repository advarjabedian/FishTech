...
path('login/', login_view, name='login'),
    ...
    path('api/operations/save-user-signature/', save_user_signature, name='save_user_signature'),
    path('api/operations/get-user-signature/', get_user_signature, name='get_user_signature'),
    ...
    path('api/product-images/<int:product_id>/upload/', upload_product_image, name='upload_product_image'),
    path('api/product-images/<int:product_id>/delete/<int:slot>/', delete_product_image, name='delete_product_image'),
    path('api/product-images/<int:product_id>/', get_product_images, name='get_product_images'),
...
path('api/profile-orders/import/confirm/', import_confirm, name='import_confirm'),
    ...
    path('api/tenant-products/', get_tenant_products_api, name='get_tenant_products_api'),
    path('api/tenant-products/add/', add_tenant_product_api, name='add_tenant_product_api'),
    path('api/tenant-products/<int:product_id>/update/', update_tenant_product_api, name='update_tenant_product_api'),
    path('api/tenant-products/<int:product_id>/delete/', delete_tenant_product_api, name='delete_tenant_product_api'),
    path('api/tenant-products/assign/', assign_product_to_customer_api, name='assign_product_to_customer_api'),
    path('api/tenant-products/unassign/<int:profile_id>/', unassign_product_from_customer_api, name='unassign_product_from_customer_api'),
